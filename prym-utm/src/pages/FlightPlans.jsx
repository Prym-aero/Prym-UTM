...
const FlightPlanForm = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="w-screen h-screen flex flex-col justify-center items-center pt-8 gap-[40px] ">
        <div className="flight-logo w-full h-[90px] bg-white/50 text-black text-[52px] font-bold flex justify-center items-center">
          PRYM AEROSPACE
        </div>
